    ...
    <div className="row col-12">
        ...
        <div className="col-8">
                <div className="col-md-12">
                    <select className="form-select" aria-label="Default select example" value={this.props.value} onChange={this.props.handleChangeSelected}>
                        <option className='text-primary'>Chọn: </option>
                            { 
                                this.state.dsPermission.length!==0 ?
                                this.state.dsPermission.map(Item=> <option key={Item.id} value={Item.id} className='text-primary'>{Item.ten_quyen}</option>) : <option className='text-warning'>Không có chức vụ nào </option>
