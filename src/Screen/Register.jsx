                      ...
                      <form className="row g-3 needs-validation" novalidate>
                        ...
                        <div className="col-12">
                          <div className="form-check">
                            ...
                            <label className="form-check-label" for="acceptTerms">I agree and accept the <Link href="#">terms and conditions</Link></label>
                        ...
                        <div className="col-12">
                          <p className="small mb-0">Already have an account? <Link href="pages-login.html">Log in</Link></p>
                        </div>
                      </form>
